...
export const ONBOARDING_SECTIONS: OnboardingSection[] = [
  {
    ...
    fields: [
      ...
      { id: 'capabilities', label: 'Requested capabilities (what should your assistant be able to do?)', type: 'textarea', placeholder: 'e.g. Transfer to a person, Schedule appointments, Reschedule, Cancel appointments, Answer common questions, Take a message' },
