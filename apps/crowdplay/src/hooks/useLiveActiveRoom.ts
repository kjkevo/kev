 ...
 * lookup) and then subscribes to it in full detail, including players —
 * the same two-step pattern /screen uses. Shared here so /trivia's waiting
 * view can show the same live picture without re-deriving it.
 */
